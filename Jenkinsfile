...
def DOCKER_AWS_CMD = "docker run -v /var/lib/jenkins:/root/.aws amazon/aws-cli"
def DOCKER_AWS_SAM_CMD = "docker run -v /var/lib/jenkins:/root/.aws amazon/aws-sam-cli-build-image-python3.8 sam"
