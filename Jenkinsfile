            ...
            steps {
                script{
                    try {
                        ...
                        sh script:"aws autoscaling update-auto-scaling-group --auto-scaling-group-name $params.autoScalingGroupName.trim() --new-instances-protected-from-scale-in", returnStdout:true;
